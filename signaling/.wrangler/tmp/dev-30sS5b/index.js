...
var Room = class {
  ...
  async fetch(request) {
    ...
    this.broadcast({ type: "peer-joined", totalPeers: this.sessions.size });
...
// .wrangler/tmp/bundle-EUI2Fl/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EUI2Fl/middleware-loader.entry.ts
